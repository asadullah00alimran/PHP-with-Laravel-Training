...
<body>
                            ...
                            <div class="card-body py-5 px-1">
                                ...
                                <form method="POST">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <button type="submit"
                                            class="btn btn-info btn-block btn-small form-control  mx-5 form-control-small gradient-custom-2 text-body mt-3" name="submit" >Register</button>
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <!-- <div class="show col-12 col-md-9 col-lg-7 col-xl-6 offfset-3">
